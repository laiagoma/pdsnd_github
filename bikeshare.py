...
def get_filters():
    ...
    Returns:
        (str) city - name of the city to analyze (currently only Washington, New York City, and Chicago available)
...
def user_stats(df):
    ...
    if 'Birth Year' not in df:
        ...
        print('The most recent bith year is: {}'.format(df['Birth Year'].max()))
